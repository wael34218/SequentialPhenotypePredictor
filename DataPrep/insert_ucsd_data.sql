...
\copy deDemo FROM '../Data/UCSDData/deDemo.csv' WITH (FORMAT CSV, DELIMITER '|', Null 'NaN', HEADER)
...
\copy deHosp FROM '../Data/UCSDData/deHosp.csv' WITH (FORMAT CSV, DELIMITER '|', Null 'NaN', QUOTE E'\b', HEADER)
...
\copy deLab FROM '../Data/UCSDData/deLab.csv' WITH (FORMAT CSV, DELIMITER '|', HEADER)   
...
\copy deMed FROM '../Data/UCSDData/deMed.csv' WITH (FORMAT CSV, DELIMITER '|', Null 'NULL', quote E'\b', HEADER)
