...
selected_diags = ["d_584", "d_518", "d_428", "d_427", "d_276", "d_486", "d_038", "d_599", "d_403",
                  "d_507", "d_401", "d_785.5", "d_414", "d_285.1", "d_496", "d_511", "d_424",
                  "d_272", "d_410"]
...
for diag in diags:
    for i in range(10):
        train[diag+str(i)] = open('../Data/w2v_diag/mimic_train_'+diag+'_'+str(i), 'w')
        test[diag+str(i)] = open('../Data/w2v_diag/mimic_test_'+diag+'_'+str(i), 'w')
...
for seq_index, seq in enumerate(all_seq):
    ...
    for diag in diags:
        test[diag+str(segment)].write(str(int(diag in diagnoses))+serial+'\n')
    for f in range(10):
        if f != segment:
            for diag in diags:
                train[diag+str(f)].write(str(int(diag in diagnoses))+serial+'\n')
